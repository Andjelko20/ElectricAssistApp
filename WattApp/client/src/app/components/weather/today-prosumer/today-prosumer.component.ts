...
@Component({
  selector: 'app-today-prosumer',
  templateUrl: './today-prosumer.component.html',
  styleUrls: ['./today-prosumer.component.css']
})
export class TodayProsumerComponent implements OnInit {
  cels = true;
